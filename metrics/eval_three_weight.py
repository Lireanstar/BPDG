...
if __name__ == '__main__':
    ...
    i = 10
    input_biased = '/root/AAAI_personachat/data/generate/test_data_biased_our_v2e39_weight%s.json'%str(i)
    input_random = '/root/AAAI_personachat/data/generate/test_data_random_2k_our_v2e39_weight%s.json'%str(i)
