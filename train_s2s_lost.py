...
from model.trainer_s2s_lost import TrainerLost
from model.text import myVocab
from model.dataset import SMPDataset_lost
from config import get_model_config_lost, get_trainer_config_lost
...
def main():
    model_config = get_model_config_lost()
    trainer_config = get_trainer_config_lost()
    ...
    train_dataset = SMPDataset_lost(trainer_config.train_datasets, vocab, transformer.n_pos_embeddings - 1)
    test_dataset = SMPDataset_lost(trainer_config.test_datasets, vocab, transformer.n_pos_embeddings - 1)

    model_trainer = TrainerLost(transformer,
                                train_dataset,
                                test_dataset,
