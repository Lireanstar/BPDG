...
from .ourv2_module import TransformerModule
...
class TransformerSoftModel(nn.Module):
    def __init__(self, n_layers, n_embeddings, n_pos_embeddings, embeddings_size,
                 ...
                 diversity_coef=0, diversity_groups=1, n_segments=None, n_gender=3, n_age=5, n_tag=502):
        ...
        self.transformer_module = TransformerModule(n_layers, n_embeddings, n_pos_embeddings, embeddings_size,
                                                    ...
                                                    ff_dropout, n_segments, n_gender=n_gender, n_age=n_age, n_tag=n_tag)
    ...
    def encode(self, x, gender=None, age=None, tag=None):
        return self.transformer_module(x, gender=gender, age=age, tag=tag)
