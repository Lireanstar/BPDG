...
import json
import logging
logger = logging.getLogger('s2s-our-unweight')
logger.setLevel(logging.INFO)
fh = logging.FileHandler('s2s-our-unweight.log', encoding='utf-8')
...
class TrainerUnweight:
    ...
    def _eval_train(self, epoch, risk_func=None):
        ...
        for i, (contexts, targets, gender, loc, tag, label) in enumerate(tqdm_data):
            ...
            outputs = self.model.decode(prevs, enc_contexts, weight=None)
