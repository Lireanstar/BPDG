...
class TrainerSoft:
    ...
    def _eval_train(self, epoch, risk_func=None):
        ...
        for i, (sc_contexts, tg_contexts, response, gender, age, tag, label) in enumerate(tqdm_data):
            ...
            enc_context_history = self.model.encode(target_contexts[1].clone(), gender=gender, age=age,
                                                    tag=tag)
    ...
    def _eval_test(self, metric_funcs={}):
        ...
        with torch.no_grad():
            ...
            for i, (sc_contexts, tg_contexts, response, gender, age, tag, label) in enumerate(tqdm_data):
                ...
                predictions = self.model.greedy(enc_contexts, weight=weight)
