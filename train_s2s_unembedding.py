...
from model.trainer_s2s_unembedding import TrainerUnembedding
from model.text import myVocab
from model.dataset import SMPDataset_our
from config import get_model_config_unembedding, get_trainer_config_unembedding
...
def main():
    ...
    trainer_config = get_trainer_config_unembedding()
    ...
    model_trainer = TrainerUnembedding(transformer,
                                       train_dataset,
                                       test_dataset,
