...
from model.model_v3_bipersona import TransformerSoftModel
from model.model_v3_trainer import TrainerSoft
from model.text import myVocab
from model.dataset import SMPDataset_v3
from config import get_model_config_soft, get_trainer_config_soft
...
def main():
    ...
    trainer_config = get_trainer_config_soft()
    ...
    train_dataset = SMPDataset_v3(trainer_config.train_datasets, vocab, transformer.n_pos_embeddings - 1, is_test=False)
    test_dataset = SMPDataset_v3(trainer_config.test_datasets, vocab, transformer.n_pos_embeddings - 1, is_test=True)
    ...
    def sample_text_func(epoch):
        ...
        for source_persona_info, target_persona_info, history_dialogue, response, gender, loc, tag, label in samples:
            ...
            enc_context_history = model_trainer.model.encode(contexts[2].clone(), gender=gender_format, loc=loc_format,
                                                             tag=tag_format)
