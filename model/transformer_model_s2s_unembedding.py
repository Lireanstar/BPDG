...
from .transformer_module_unembedding import TransformerModule


class TransformerUnembeddingModel(nn.Module):
    def __init__(self, n_layers, n_embeddings, n_pos_embeddings, embeddings_size,
                 ...
                 diversity_coef=0, diversity_groups=1, n_segments=None, n_gender=None, n_loc=None, n_tag=None):

        super(TransformerUnembeddingModel, self).__init__()
